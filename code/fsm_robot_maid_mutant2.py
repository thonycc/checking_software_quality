...
## features : - The link which enable the robot to clean after sleeping has been misdirected from sleeping to dancing
##            - The link which enable the robot to sleep after cooking has been misdirected from cooking to dancing
##

## Implementation of the finite state machine thanks to the Python module fysom
fsm=Fysom(initial = 'sleeping',
          events= [('sleep','cooking','dancing'), ## Here are the transitions
