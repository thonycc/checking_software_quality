...
while(1):
    ...
    if i == 'sleep':
        if fsm.current == 'sleeping':
            print('I am already sleeping')
        else :
            fsm.sleep()
            print('Ok, I am going to sleep')
            break
    elif i == 'vacuum':
        fsm.vacuum()
        print('Ok, I am going to vacuum')
    elif i == 'cook' :
        fsm.cook()
        print('Ok, I am going to cook')
    elif i == 'dance' :
        fsm.dance()
        print('Ok, I am going to dance')
    elif i == 'clean' :
        fsm.clean()
        print('Ok, I am going to clean')
    else :
